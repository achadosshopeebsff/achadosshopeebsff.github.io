...
- **Foco em produto BARATO, com variedade de preço.** Faixas (`priceTierQuotas`, vagas **mínimas** de um catálogo de 600): R$ 10–19: 70 · 20–29: 90 · 30–39: 90 · 40–49: 70 · 50–59: 60 · 60–69: 50 (**430 até R$ 69**, 72%) · 70–99: 40 · 100–199: 30 · 200–499: 25 · 500–1.000: 10. Produto de R$ 200+ **não é descartado**: tem vaga própria, só em quantidade moderada.
- **Limite MÁXIMO para os caros** (`priceCaps`): no máximo **17%** do catálogo com R$ 100+ (102 de 600) e no máximo **5%** com R$ 300+ (30 de 600). Vale para todas as regras. Simulação de 600: 83% até R$ 69, R$ 100+ = 11%, R$ 300+ = 4%. A distribuição real de cada rodada fica em `sync-meta.json > diagnostics.priceDistribution`.
- **Portão de qualidade** (`qualityByPriceTier`, vale para TODOS os produtos): R$ 10–69: nota **4,7+** e **50+ vendas** · R$ 70–199: 4,6+ e 50+ · R$ 200–499: 4,7+ e 30+ · R$ 500+: 4,7+ e 20+. Nota máxima com poucas vendas **não passa**. Nota mínima geral: `minRating` 4,6.
- **Ótimos descontos em degraus** (`dealTiers`, vagas mínimas cumulativas): **80%+ → 25 · 60%+ → 70 · 40%+ → 150 · 30%+ → 230**, sempre com prova de qualidade (nota 4,7+; 100 vendas para 80%, 75 para 60%, 50 para os demais). Desconto grande sem vendas é isca (preço “de” inflado) e não entra. A pontuação também premia “nota 4,9+ com 500+ vendas”.
- **Comissão** (`commissionQuotas`, em toda rodada): **30%+: 60** · 20–29,99%: 45 · 10–19,99%: 65; teto de 35% do catálogo com comissão 10%+ (`maxCommissionShare`, 210 de 600). Produtos com **20%+ só entram com nota ≥ 4,7 e ≥ 30 vendas** (`highCommissionMinRating` / `highCommissionMinSales`): comissão alta nunca compensa produto ruim. A pontuação considera a **comissão esperada por venda (R$ = preço × %)** com teto baixo.
- **Smartphones:** só até R$ 1.000 e **a partir de R$ 250** (`tagMinPrice`; abaixo disso é brinquedo/golpe). Cartão de memória, pendrive, SSD, microfone etc. não contam como celular. Vagas garantidas de Smartphones: 10 (Notebooks: 0), pois celular é naturalmente caro e só entra dentro do limite `priceCaps`.
...
## Reforma do catálogo: 600 achados e novas categorias

- **600 produtos** por ciclo (`maxProducts`; `minDynamicProducts` 300). Se poucos produtos passarem no portão de qualidade, o bot publica **menos que 600** (100% novo) em vez de aceitar produto ruim; confira o total em `products.json`/`sync-meta.json`.
- **Categorias com vaga garantida** (`mandatoryQuotas`, mínimos por rodada): Cabelo Liso 30 · Eletrônicos 60 · Caixas de Som 20 · **Cozinha 60** · **Casa 70** · **Limpeza 50** · **Moda 70** · **Fitness 30** · **Beleza 40** · **Religião 12**. Quem já entrou por outra regra conta para a cota.
- **Novas categorias:** **Limpeza** (kits de limpeza, spin scrubber, desengordurante, luvas de nitrilo, rolo adesivo, removedor de pelos de pets, robô aspirador, máquina a vapor…) e **Religião** (Bíblias: clássicas, de estudo, ilustradas, personalizadas, de capa estética; terço, devocional, quadros com versículo…). Ambas viram chips no site.
- **+227 palavras-chave** (nada foi removido), buscadas em rodízio a cada rodada (`mandatoryKeywordsPerRun`: 120): todos os itens da sua lista (máquina 3 em 1, aspirador robô, spin scrubber, mini waffle, desfiador, sacos a vácuo, fones TWS, caneta limpadora, kits 10/20 em 1, suporte rotativo, power bank MagSafe, hub USB-C 7 em 1, lixeira com sensor, centro de mesa giratório, organizador de temperos, dispensador de arroz, lençol 400 fios, rack de canto, kits de limpeza, roupas oversized/loungewear/wide leg, parafusadeira, abridor magnético, body splash, kit skincare, caneca parede dupla, bule, LED strip, Bíblias…) **mais ideias de itens do dia a dia brasileiro** (jogo de panelas/facas/tábua, potes herméticos, cuscuzeira, tapioqueira, toalhas, cobertor, travesseiro nasa, varal, capacho, cortina blackout, vassoura/rodo mágico, mop giratório, camisa polo, cueca, meias, pijama, legging, faixa elástica, corda de pular, perfume árabe, protetor solar, esmalte, brinquedo/cama pet…).
- A classificação (`inferTag`) foi ampliada para reconhecer esses itens (waffle, batedeira, dispensador, lixeira, rack, sacos a vácuo, camisa, pijama, legging, fita LED, suporte de celular, MagSafe…) sem mexer nas categorias antigas.
- Palavras de comissão alta: 58 termos (24 por rodada) — inclui limpeza, Bíblia, camiseta, loungewear, body splash, kit skincare, lixeira, panelas, legging, perfume.
- Custo de API por rodada ≈ o mesmo de antes (o rodízio principal passou a buscar 1 página por palavra). Se a Shopee limitar, o próprio coletor espera e tenta de novo.
