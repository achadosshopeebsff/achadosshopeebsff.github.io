...
- **Foco em produto BARATO.** Faixas (`priceTierQuotas`, vagas **mínimas** de 500): R$ 10–29: 130 · 30–49: 110 · 50–69: 70 · 70–99: 40 · 100–199: 20 · 200–299: 8 · 300–1.000: 10 (388 no total; o resto vem da pontuação geral, que também favorece o barato).
- **Limite MÁXIMO para os caros** (`priceCaps`): no máximo **15%** do catálogo com R$ 100+ (75 de 500) e no máximo **5%** com R$ 300+ (25 de 500). Vale para todas as regras (cotas, comissão, descontos, categorias e preenchimento geral), então produto caro entra só em quantidade moderada. Simulação com 40% dos candidatos caros: 67% do catálogo até R$ 50, mediana R$ 35, R$ 100+ = 11%, R$ 300+ = 4%. Para liberar mais caro, aumente `maxShare`. A distribuição real de cada rodada fica em `sync-meta.json > diagnostics.priceDistribution`.
